...
export const DialogContent = <T extends ValidComponent = "div">(
  ...
  return (
    <DialogPrimitive.Portal>
      ...
      >
        {local.children}
        <DialogPrimitive.CloseButton class="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-[opacity,box-shadow] hover:opacity-100 focus:outline-none focus:ring-[1.5px] focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none cursor-pointer">
          <svg
