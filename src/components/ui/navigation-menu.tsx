...
export const NavigationMenu = <T extends ValidComponent = "ul">(
  ...
  return (
    <NavigationMenuPrimitive
      class={cn(
        "flex w-max items-center justify-center gap-x-2 px-4",
        local.class,
      )}
      {...rest}
    >
...
export const NavigationMenuTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      class={cn(
        "inline-flex w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium outline-hidden transition-colors duration-300 disabled:pointer-events-none disabled:opacity-50",
        local.class,
      )}
      {...rest}
    >
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Content
        class={cn(
          "absolute left-0 top-0 p-4 outline-hidden",
